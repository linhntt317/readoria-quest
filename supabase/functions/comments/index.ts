...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Create service role client for operations that bypass RLS (like anonymous comments)
    ...
    if (req.method === "POST") {
      ...
      // Use service role client for anonymous comments (bypass RLS)
      // Use authenticated client if user is logged in
      ...
      if (insertError) {
        console.error(
          "Error creating comment - Full error:",
