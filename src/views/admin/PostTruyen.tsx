...
const PostTruyen = () => {
  ...
  const { execute: executeFetch } = useAsyncWithLoading();
    ...
    try {
      await executeFetch(async () => {
        ...
        if (data.err === 0 && data.exists !== false) {
          ...
          setValue(
            "status",
            data.is_completed ? "Hoàn thành" : "Đang cập nhật"
          );
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Nhập link truyện từ JJWXC để tự động điền thông tin hoặc điền thủ
              công
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="status"
                      {...register("status")}
                      placeholder="Hoàn thành / Đang cập nhật"
                      readOnly
                    />
                  </div>
